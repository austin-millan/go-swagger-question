...
import (
	...
	"github.com/austin-millan/go-swagger-question/pkg/handlers/base"
	"github.com/austin-millan/go-swagger-question/pkg/server/base_extra/operations"
...
func configureAPI(api *operations.BaseExtraServerAPI) http.Handler {
